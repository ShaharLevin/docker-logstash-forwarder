...
RUN curl -Lo /usr/local/bin/docker-logstash-forwarder https://github.com/lshahar/docker-logstash-forwarder/releases/download/latest/linux_amd64_docker-logstash-forwarder \
